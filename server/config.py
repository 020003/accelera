...
_DEFAULTS: dict[str, str] = {
    ...
    "VLLM_DISCOVER_TIMEOUT": os.getenv("VLLM_DISCOVER_TIMEOUT", "3000"),
    "VLLM_DEFAULT_PORT": os.getenv("VLLM_DEFAULT_PORT", "8000"),
    # Alerting
...
VLLM_URL = _DEFAULTS["VLLM_URL"]
VLLM_DISCOVER_TIMEOUT = int(_DEFAULTS["VLLM_DISCOVER_TIMEOUT"])
VLLM_DEFAULT_PORT = int(_DEFAULTS["VLLM_DEFAULT_PORT"])
